    ...
    if (isLoggedIn) {
        ...
        links = (
            ...
            <ul className="navbar-nav ms-auto">
                ...
                <li className="nav-link text-nowrap text-primary " onClick={onLogoutSuccess} style={{ cursor: 'pointer'    }}>
        ...
        <div className="bg-secondary shadow mb-2 p-0">
            <nav className="navbar navbar-expand navbar-light container p-0">
                ...
                <Link className="navbar-brand fs-3 text-primary" to="/">
                    <h1 className='fw-bold'><img src={logo} width="50" alt='Wolf Logo' />Wolf</h1>
                </Link>
                {links}
            </nav >
        </div >
