        ...
        <div className="card mb-3">
            <div>
                ...
                <div className="card-header input-group justify-content-end">
                    ...
                    <button type="button" className="btn btn-outline-primary instagram-title">
                        {t('Search')}
                        <img src="https://img.icons8.com/nolan/16/000000/search.png" alt="search button" />
                    </button>
                </div>
            </div>
            <div className="list-group-flush">
                ...
                {loadFailure && <div className="alert alert-danger text-danger m-3" role="alert">
                    <img src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/30/000000/external-alert-security-flaticons-lineal-color-flat-icons.png" alt='alert icon' />
