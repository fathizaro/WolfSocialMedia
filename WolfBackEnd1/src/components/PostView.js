        ...
        <>
            <div className="card gedf-card mb-3">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        {ownedByLoggedInUser && (
                            <label className="btn btn-default ms-auto" onClick={() => setModalVisible(true)}>
                                <img src="https://img.icons8.com/nolan/22/000000/delete-forever.png" alt='' />
                            </label>
                ...
                <div className="card-footer lh-1 ">
                    {isLoggedIn && <>
                        <Link className="card-link text-decoration-none "><img src="https://img.icons8.com/nolan/16/000000/facebook-like.png" alt='' /> {t('Like')}</Link>
                        <Link className="card-link text-decoration-none"><img src="https://img.icons8.com/nolan/16/000000/topic.png" alt='' /> {t('Comment')}</Link>
                    </>}
                    <Link className="card-link text-decoration-none float-end d-inline">
                        <img src="https://img.icons8.com/nolan/16/000000/share.png" alt='' />
                        {t('Share')}
                    </Link>
                </div>
