                                ...
                                {editable && (
                                    <div className="buttons">
                                        <button className="btn btn-primary px-4" onClick={() => setInEditMode(true)}>
                                            ...
                                            {t('Edit')}<img src="https://img.icons8.com/nolan/30/000000/multi-edit.png" alt='Edit' />
                                        </button>
                                        <button className="btn btn-outline-danger px-4 ms-3" onClick={() => setModalVisible(true)}>{t('Delete')}<img src="https://img.icons8.com/nolan/22/000000/delete-forever.png" alt='Delete' /></button>
                                    </div>
                                )}
                            </div>
                        )}
                            ...
                            <div className="text-center mt-3">
                                ...
                                <div className="buttons">
                                    <button className="btn btn-primary px-4" onClick={onClickSave} disabled={pendingApiCall}>
                                        {pendingApiCall && <span className="spinner-border spinner-border-sm"></span>}
                                        {t('Save')}<img src="https://img.icons8.com/nolan/30/000000/save-as.png" alt='Save' />
                                    </button>
                                    <button className="btn btn-outline-danger px-4 ms-3" onClick={() => setInEditMode(false)} disabled={pendingApiCall}>
                                        {t('Cancel')}<img src="https://img.icons8.com/nolan/30/000000/cancel.png" alt='Cancel' />
                                    </button>
                                </div>
                            </div>
                        )}
