    ...
    return (
        <div className="container">
            ...
            <form className="shadow-lg p-3 mb-5 bg-body rounded border border-primary d-grid gap-2 col-8 mx-auto mt-5">
                ...
                <Input name="username" label={t("Email")} placeholder="Username" error={usernameError} onChange={onChange}></Input>
                <Input name="displayName" label={t("Username")} placeholder="Display Name" error={displayNameError} onChange={onChange}></Input>
